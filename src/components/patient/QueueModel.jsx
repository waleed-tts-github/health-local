...
const QueueModal = () => {
  ...
  if (currentModal !== 'queue') return null;
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-2 z-50">
      <div className="bg-white/90 backdrop-blur-xl rounded-2xl max-w-md w-full max-h-[80vh] sm:max-h-[90vh] overflow-y-auto sm:p-5 p-3 shadow-2xl border border-green-100/30 text-center">
        <div className="flex items-center justify-between sm:mb-4 mb-2">
          <h3 className="sm:text-sm text-xs font-bold text-green-700">Availability Confirmed</h3>
          <button 
            onClick={closeModal} 
        ...
        <div className="sm:mb-4 mb-2">
          ...
          <div className="sm:mb-3 mb-2">
            <span className="text-gray-600 sm:text-xs text-[10px]">You Are </span>
            <span className="bg-green-100 text-green-600 sm:px-2 px-1.5 sm:py-0.5 py-0.25 rounded-full sm:text-xs text-[10px] font-semibold">Next</span>
            <span className="text-gray-600 sm:text-xs text-[10px]"> In Line</span>
          </div>
          <div className="sm:mb-3 mb-2">
            <span className="text-gray-600 sm:text-xs text-[10px]">Approx. Waiting </span>
            <span className="bg-green-100 text-green-600 sm:px-2 px-1.5 sm:py-0.5 py-0.25 rounded-full sm:text-xs text-[10px] font-semibold">{queueWaitTime} Min...</span>
          </div>
        </div>
