...
const ServiceSelection = ({ isAppointmentsExpanded, setIsAppointmentsExpanded, appointments, getRemainingTime, setIsModalOpen }) => {
  const { handleShowCyberClinics, handleServiceSelect, setIsBookingThroughClinic } = useConsultationFlow();
        ...
        >
          <div className="flex justify-center mb-3 sm:mb-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/30 rounded-full flex items-center justify-center animate-pulse">
              <img src={logo} className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
          </div>
