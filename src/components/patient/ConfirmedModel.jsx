    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-2 z-50">
      <div className="bg-white/90 backdrop-blur-xl rounded-2xl max-w-md w-full max-h-[80vh] sm:max-h-[90vh] overflow-y-auto sm:p-5 p-3 shadow-2xl border border-green-100/30 text-center">
        ...
        <div className="sm:mb-4 mb-2">
          ...
          <p className="text-gray-600 sm:text-xs text-[10px] sm:mb-4 mb-2">At Your Scheduled Time</p>
          <div className="flex justify-center items-center sm:gap-8 gap-4 sm:mb-4 mb-2">
            <div>
              <p className="sm:text-2xl text-xl font-bold text-gray-800">Today</p>
            </div>
            <div>
              <p className="sm:text-2xl text-xl font-bold text-gray-800">9:30 PM</p>
            </div>
          </div>
        </div>
