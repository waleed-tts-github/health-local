          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 pb-6">
            <div className="flex flex-col items-center space-y-8">
              ...
              <div className="text-center">
                ...
                <div>
                  <span className="text-white/80 text-sm">Approx. Waiting </span>
                  <span className="bg-white/20 text-white px-4 py-2 rounded-full backdrop-blur-sm font-semibold text-sm">{queueWaitTime} Min...</span>
                </div>
              </div>
            </div>
          </div>
