    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Search Blood Volunteers</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Results (03)</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {volunteers.map((volunteer) => (
              <div key={volunteer.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-600 mb-3">{volunteer.address}</p>
          ...
          <div className="flex justify-center">
            <button className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-8 rounded-lg transition-colors">
              Next
            </button>
          </div>
          ...
          <div className="flex justify-center mt-6 space-x-2">
            ...
            <button className="px-3 py-1 text-gray-500 hover:text-gray-700">1</button>
            <button className="px-3 py-1 text-gray-500 hover:text-gray-700">2</button>
            <button className="px-3 py-1 bg-green-600 text-white rounded">3</button>
            ...
            <button className="px-3 py-1 text-gray-500 hover:text-gray-700">6</button>
            <button className="px-3 py-1 text-gray-500 hover:text-gray-700">›</button>
          </div>
        </div>
      </div>
      ...
      {/* Request Modal */}
{showRequestModal && (
  <div className="fixed inset-0 bg-grey  bg-opacity-50  flex items-center justify-center z-50 p-2 sm:p-4 h-full">
    <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900">Blood Donation Volunteer</h3>
        <button 
      ...
      <h6 className="text-base sm:text-lg font-medium text-gray-900 mb-3">
      ...
      <div className="space-y-3">
        <div>
          ...
          <div className="relative">
            <User className="absolute left-2 top-2.5 h-3 w-3 sm:h-4 sm:w-4 text-gray-400" />
            <input
              type="text"
              value={contactPerson}
              onChange={(e) => setContactPerson(e.target.value)}
              placeholder="Ali Hassan"
              className="w-full pl-8 sm:pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <Phone className="absolute left-2 top-2.5 h-3 w-3 sm:h-4 sm:w-4 text-gray-400" />
            <input
              type="tel"
              value={phoneNumber}
        ...
        <div>
          ...
          <div className="relative">
            <MapPin className="absolute left-2 top-2.5 h-3 w-3 sm:h-4 sm:w-4 text-gray-400" />
            <input
              type="text"
              value={contactPlace}
